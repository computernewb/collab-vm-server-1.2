...
AgentClient::AgentClient(asio::io_service& service) :
...
void AgentClient::OnReadUploadReq(const asio::error_code& ec, size_t size, std::shared_ptr<SocketCtx> ctx)
{
	if (ctx->IsStopped())
		return;
...
void AgentClient::OnReadHeader(const asio::error_code& ec, size_t size, std::shared_ptr<SocketCtx> ctx)
{
	if (ctx->IsStopped())
		return;
...
void AgentClient::OnReadBody(const asio::error_code& ec, size_t size, std::shared_ptr<SocketCtx> ctx)
{
	if (ctx->IsStopped())
		return;
...
void AgentClient::OnWrite(const asio::error_code& ec, size_t size, std::shared_ptr<SocketCtx> ctx)
{
	if (ctx->IsStopped())
		return;
...
void AgentClient::OnWriteAgentUpload(const asio::error_code& ec, size_t size, std::shared_ptr<SocketCtx> ctx)
{
	if (ctx->IsStopped())
		return;
...
void AgentClient::OnWriteFileUpload(const asio::error_code& ec, size_t size, std::shared_ptr<SocketCtx> ctx)
{
	if (ctx->IsStopped())
		return;
...
void AgentClient::OnHeartbeatTimeout(const asio::error_code& ec)
{
	if (ec)
		return;
